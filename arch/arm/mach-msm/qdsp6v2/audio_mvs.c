...
#if defined (CONFIG_SKY_SND_MVS)
	if(mvs_if_used == 1){
#ifndef CONFIG_MACH_MSM8X60_EF33S	// jmlee set voc path , this control removed
...
#ifdef CONFIG_MACH_MSM8X60_EF65L // 20131212 hdj Qpatch VT MO Call reset on MVS release.
        msleep(20);
