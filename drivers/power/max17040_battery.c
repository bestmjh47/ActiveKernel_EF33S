...
#define SKY_SOC_EMPTY	16   ///  3.60v  12->16
...
#endif
	max17040_data.soc_raw = avalue; //hglim
...
//	sleep_dbg("MAX17040_WORK RTC CALL.\n");				
	...
	printk("soc=%d,raw_soc_100=%d,vcell=%d\n", max17040_data.soc, max17040_data.soc_raw, max17040_data.vcell);
	//max17040_data.soc = (max17040_data.soc<1)? 1 : max17040_data.soc; //hglim only for test
